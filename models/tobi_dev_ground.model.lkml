...
include: "/views/**/*.view"
include: "/Testing_LookML.dashboard.lookml"


# Datagroups define a caching policy for an Explore. To learn more,
# use the Quick Help panel on the right to see documentation.

datagroup: tobi_dev_ground_default_datagroup {
...
# To see the Explore you’re building, navigate to the Explore menu and select an Explore under "Tobi Dev Ground"
